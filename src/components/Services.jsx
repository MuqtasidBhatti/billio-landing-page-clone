  ...
  return (
    <section className="py-20 px-6 md:px-16 bg-white">
      ...
      <div className='text-center mb-12'>
        ...
        <p className='text-gray-500 mt-3'>Everything you need to grow your wealth smarter</p>
      </div>
      ...
      <div className='max-w-6xl mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-6'>
        {services.map((item, index) => (
          <div
            key={index}
            className='p-6 bg-gray-50 rounded-xl hover:shadow-md transition hover:scale-105 '
          >
